...
const PriceModifierSearchBar = ({ searchTerm, setSearchTerm, onAddClick, placeholder = "Buscar modificador...", buttonText = "NUEVO MODIFICADOR" }) => (
...
export default PriceModifierSearchBar;
