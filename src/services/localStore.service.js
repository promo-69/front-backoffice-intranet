...
const SEED_MOVIES = [
  {
    ...
    synopsis: "Wade Wilson y Wolverine unen fuerzas para salvar el universo Marvel.",
  },
  {
    id: 2,
    title: "Inside Out 2",
  ...
  },
  {
    ...
    synopsis: "Un grupo de jóvenes colonianos enfrenta la forma de vida más aterradora.",
  },
];

const SEED_SHOWTIMES = [
  // Deadpool
  { id: 1, movie_id: 1, room: "Sala 1 - 3D IMAX", date: "2026-05-12", time: "14:00", price: 8.50, available_seats: 120, total_seats: 144 },
  { id: 2, movie_id: 1, room: "Sala 2 - Tradicional", date: "2026-05-12", time: "17:30", price: 6.00, available_seats: 55, total_seats: 120 },
  { id: 3, movie_id: 1, room: "Sala 1 - 3D IMAX", date: "2026-05-12", time: "20:00", price: 8.50, available_seats: 144, total_seats: 144 },
  // Inside Out
  { id: 4, movie_id: 2, room: "Sala 3 - Familiar", date: "2026-05-12", time: "11:00", price: 5.50, available_seats: 80, total_seats: 100 },
  { id: 5, movie_id: 2, room: "Sala 3 - Familiar", date: "2026-05-12", time: "15:00", price: 5.50, available_seats: 100, total_seats: 100 },
  // Alien
  { id: 6, movie_id: 3, room: "Sala 4 - Premium", date: "2026-05-12", time: "21:00", price: 10.00, available_seats: 60, total_seats: 60 },
];
...
const SEED_PRODUCTS = [
  { id: 1, name: "Cotufas Pequeñas", category: "Snack", price: 3.00, emoji: "🍿" },
  { id: 2, name: "Cotufas Grandes", category: "Snack", price: 5.00, emoji: "🍿" },
  { id: 3, name: "Refresco Mediano", category: "Bebida", price: 2.50, emoji: "🥤" },
  { id: 4, name: "Refresco Grande", category: "Bebida", price: 3.50, emoji: "🥤" },
  { id: 5, name: "Agua Mineral", category: "Bebida", price: 1.50, emoji: "💧" },
  { id: 6, name: "Nachos con Queso", category: "Snack", price: 4.00, emoji: "🧀" },
  { id: 7, name: "Hot Dog", category: "Comida", price: 4.50, emoji: "🌭" },
  { id: 8, name: "Chocolate", category: "Dulce", price: 2.00, emoji: "🍫" },
];

const SEED_COMBOS = [
  { id: 101, name: "Combo Amigos", description: "2 Cotufas Grandes + 2 Refrescos Grandes", price: 15.00, emoji: "🎉", items: ["Cotufas Grandes x2", "Refresco Grande x2"] },
  { id: 102, name: "Combo Solo", description: "1 Cotufas Medianas + 1 Refresco Mediano", price: 7.00, emoji: "🎬", items: ["Cotufas Pequeñas x1", "Refresco Mediano x1"] },
  { id: 103, name: "Combo Familiar", description: "4 Cotufas + 4 Refrescos + 4 Chocolates", price: 28.00, emoji: "👨‍👩‍👧‍👦", items: ["Cotufas Grandes x4", "Refresco Grande x4", "Chocolate x4"] },
...
export function confirmSeats(showtimeId, seatIds) {
  ...
  const updated = showtimes.map((s) =>
    s.id === showtimeId
      ? { ...s, available_seats: Math.max(0, s.available_seats - seatIds.length) }
      : s
  );
